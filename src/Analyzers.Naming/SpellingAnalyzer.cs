...
using NationalInstruments.Tools.Analyzers.Naming.Properties;
using NationalInstruments.Tools.Analyzers.Naming.Text;
using NationalInstruments.Tools.Analyzers.Utilities;
using NationalInstruments.Tools.Analyzers.Utilities.Extensions;

namespace NationalInstruments.Tools.Analyzers.Naming
{
    /// <summary>
    ...
    {
        internal const string RuleId = "NI1704";
