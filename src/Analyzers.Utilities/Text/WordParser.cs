...
namespace NationalInstruments.Tools.Analyzers.Utilities.Text
{
    /// <summary>
    ...
    public class WordParser
    {
        ...
        {
            return char.IsLetter(c) && !char.IsUpper(c) ? !char.IsLower(c) : false;
        }
        ...
        private string NextWordCore()
        {
            ...
            return ParseNext() ? _buffer.ToString() : null;
        }
        ...
        {
            for (var index = _index; index < _text.Length; index++)
            {
                var c = _text[index];
        ...
        private bool IsIgnored(char c)
        {
            ...
            return SkipMnemonics ? c == '&' || c == '_' : false;
        }
    }
}
