...
namespace NationalInstruments.Analyzers.Utilities.Extensions
{
    ...
    public static class IMethodSymbolExtensions
    {
        ...
        /// <summary>
        /// Whether the method is the ObjectEquals method and explicitly declared
        /// (i.e. not auto-generated by the compiler).
        /// </summary>
        /// <param name="method">the method symbol to check.</param>
        /// <returns>true if the method is the ObjectEquals method and explicitly declared, false otherwise.</returns>
        public static bool IsExplicitEquals(this IMethodSymbol method)
